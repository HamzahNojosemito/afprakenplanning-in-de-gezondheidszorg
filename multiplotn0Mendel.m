...
% voor verschillende n0 (aantal patienten ingepland op t=0)
...
n0_array = 1:10; % reeks met aantal patienten ingepland op t = 0
for n0 = n0_array
    % //////////////////////////////GEBRUIKERSINPUT/////////////////////////////
...
string_array = cell(size(n0_array));
for i = 1:numel(n0_array)
    string_array{i} = ['n0=' num2str(n0_array(i))];
end
legend(string_array,'Location','northwest','Orientation','vertical')
lgd = legend;
lgd.NumColumns = 2;